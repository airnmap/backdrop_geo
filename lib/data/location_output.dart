...
/// See also:
///
///  * [BackdropResultError], which contains details on why/what failed.
class LocationOutput extends BackdropResult {
  LocationOutput._(
      bool isSuccessful, BackdropResultErr error, this.locations)
